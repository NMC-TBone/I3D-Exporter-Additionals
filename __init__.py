...
classes = [
    ...
    orientation_tools.I3DEA_OT_freeze_trans,
    orientation_tools.I3DEA_OT_freeze_rot,
    orientation_tools.I3DEA_OT_freeze_scale,
    orientation_tools.I3DEA_OT_freeze_all,
