...
class I3DEA_PG_List(bpy.types.PropertyGroup):
    ...
    alpha_box: BoolProperty(
        name="Alpha",
        description="If checked it will set alpha settings to diffuse node",
        default=False
    )
    ...
    dirt_diffuse: StringProperty(
        name="Dirt diffuse",
        description="Add dirt diffuse texture",
        subtype='FILE_PATH',
        default=""
    )
    ...
    add_empty_int: IntProperty(
        name="Number of empties add: ",
        description="Place your number",
        default=1,
        min=1,
        max=5
    )
    piece_distance: FloatProperty(
        name="Track piece distance: ",
        description="Add track piece distance",
        default=0.2,
        precision=10,
        min=0.0001
    )
    curve_length_disp: StringProperty(
        name="curve_length",
        default="0.0"
    )
    ...
    rubber_track: BoolProperty(
        name="Rubber Track",
        description="Check this if you want to visualize a rubber track",
        default=False
    )
    advanced_mode: BoolProperty(
        name="Advanced Mode",
        description="Add more options  for UVset2 creation and Track setup",
        default=False
    )
    ...
    motion_type: EnumProperty(
        name="Motion Types",
        items=[
            ('UNIFORM', 'Uniform Count', "Sets the fixed number of empties to be uniformly "
            ...
            ('ADAPTIVE', 'Adaptive Spacing', "Adjusts the spacing of empties based on the length of the longest curve, "
            ...
            ('DISTANCE', 'Distance', "Specifies the fixed distance between each empty, placing empties 0.2 units apart "
