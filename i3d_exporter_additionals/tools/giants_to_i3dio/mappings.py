...
BASE_OBJECT_PROP_MAPPINGS = {
    ...
    "i3D_clipDistance": (
        ...
        None,
        "obj",
        "ANY",  # Default in Giants Exp is 0.0, skip if 0.0
    ...
    "i3D_forceVisibilityCondition": (
        "use_parent",
        bool,
        lambda o, v: setattr(o.i3d_attributes, "use_parent", not v),
        "obj",
        "ANY",
        None,
    ),
    ...
    "i3D_weatherMask": (
        None,
        str,
        lambda o, v: migrate_mask(o, v, attr_path="weather_required_mask"),
        "obj",
        "ANY",
        has_visibility_condition,
    ),
    "i3D_weatherPreventMask": (
        None,
        str,
        lambda o, v: migrate_mask(o, v, attr_path="weather_prevent_mask"),
        "obj",
        "ANY",
        has_visibility_condition,
    ),
    "i3D_viewerSpacialityMask": (
        None,
        str,
        lambda o, v: migrate_mask(o, v, attr_path="viewer_spaciality_required_mask"),
        "obj",
        "ANY",
        has_visibility_condition,
    ),
    "i3D_viewerSpacialityPreventMask": (
        None,
        str,
        lambda o, v: migrate_mask(o, v, attr_path="viewer_spaciality_prevent_mask"),
        "obj",
        "ANY",
        has_visibility_condition,
    ),
    ...
    "i3D_collisionFilterGroup": (
        None,
        int,
        lambda o, v: migrate_mask(o, v, attr_path="collision_filter_group"),
        "obj",
        "MESH",
        has_rigid_body,
    ),
    "i3D_collisionFilterMask": (
        None,
        int,
        lambda o, v: migrate_mask(o, v, attr_path="collision_filter_mask"),
        "obj",
        "MESH",
        has_rigid_body,
    ),
    ...
    "i3D_navMeshMask": (
        None,
        int,
        lambda o, v: migrate_mask(o, v, attr_path="nav_mesh_mask", data_target=True),
        "data",
        "MESH",
        None,
    ),
