...
class I3DEA_OT_skeletons(bpy.types.Operator):
    ...
    def create_base_vec(self, is_harvester):
        ...
        self.create_skel_node(
            "playerRightHandTarget",
            steering_wheel,
            True,
    ...
    def create_player(self, steering_wheel=None):
        ...
        self.create_skel_node(
            "player_rightFoot", player_root, True, translate=(-0.184, -0.393, -0.514), rotation=(0, 0, math.radians(10))
        )
        self.create_skel_node(
            "player_leftFoot", player_root, True, translate=(0.184, -0.393, -0.514), rotation=(0, 0, math.radians(-10))
        )
    ...
    def create_lights(self):
        ...
        # Blender
        # (self, name, parent, coneAngle, range, dropOff, rgb, translate=(0, 0, 0), rotation=(0, 0, 0),
        # castShadowMap=False)
        # Maya
        # (self, name, parent, coneAngle, intensity, dropOff, rgb, locatorScale=50, rotation=['0deg', '0deg', '0deg'],
        # translation=[0, 0, 0], castShadowMap=False, depthMapBias=0.001, depthMapResolution=256)
        self.create_light(
            "frontLightLow",
            default_lights,
            math.radians(80),
        ...
        front_light_high = self.create_light(
            "frontLightHigh",
            default_lights,
            math.radians(70),
            25,
        ...
        high_beam_high = self.create_light(
            "highBeamHigh",
            default_lights,
            math.radians(30),
            60,
            0.5,
            (0.85, 0.85, 1),
            rotation=(math.radians(-80), 0, math.radians(5)),
        )
        self.create_light(
            "highBeamHigh2",
            high_beam_high,
        ...
        self.create_light(
            "licensePlateLightHigh", default_lights, 120, 0.5, 2, (1, 1, 1), rotation=(math.radians(90), 0, 0)
        )
        ...
        work_light_front_high1 = self.create_light(
            "workLightFrontHigh",
            work_lights,
            math.radians(90),
            25,
        ...
        work_light_back_high1 = self.create_light(
            "workLightBackHigh",
            work_lights,
            math.radians(90),
            25,
        ...
        self.create_light(
            "workLightBackHigh2",
            work_light_back_high1,
            math.radians(90),
            25,
            0.4,
            (0.85, 0.85, 1),
            rotation=(math.radians(5.41377), math.radians(37.1585), math.radians(16.0129)),
        )
        # backlights
        back_lights = self.create_skel_node("5_backLights", lights_group)
        back_lights_high1 = self.create_light(
            "backLightsHigh",
            back_lights,
            math.radians(130),
            2.5,
        ...
        self.create_light(
            "backLightsHigh2", back_lights_high1, math.radians(130), 2.5, 0.4, (0.5, 0, 0), rotation=(0, 0, 0)
        )
        # turn lights
        turn_lights = self.create_skel_node("6_turnLights", lights_group)
        turn_light_left_front = self.create_light(
            "turnLightLeftFront",
            turn_lights,
            math.radians(120),
            4,
        ...
        self.create_light(
            "turnLightLeftBack", turn_light_left_front, math.radians(120), 4, 0.6, (0.31, 0.14, 0), rotation=(0, 0, 0)
        )
        turn_light_right_front = self.create_light(
            "turnLightRightFront",
            turn_lights,
            math.radians(120),
            4,
        ...
        self.create_light(
            "turnLightRightBack", turn_light_right_front, math.radians(120), 4, 0.6, (0.31, 0.14, 0), rotation=(0, 0, 0)
        )
        # beacon lights
        ...
        reverse_light1 = self.create_light(
            "reverseLightHigh",
            reverse_lights,
            math.radians(130),
            2.5,
    ...
    def create_vehicle_attacher_joints(self, is_harvester):
        ...
        if not is_harvester:
            ...
            attacher_joint_back_rot2 = self.create_skel_node(
                "attacherJointBackRot2",
                attacher_joint_back_rot,
                translate=(0, -1, 0),
                rotation=(math.radians(13), 0, math.radians(-180)),
            )
            self.create_skel_node(
                "attacherJointBack", attacher_joint_back_rot2, True, rotation=(0, 0, math.radians(-90))
            )
            ...
            self.create_skel_node(
                "referencePointBackBottom", attacher_joint_back_arm_bottom_trans, translate=(0, -1, 0)
            )
    ...
    def create_traffic_vehicle(self):
        ...
        self.create_light(
            ...
            rotation=(math.radians(-80), 0, 0),
            translate=(0, -3.5, 0.6),
            cast_shadow_map=False,
        )
        front_light_high1 = self.create_light(
            "frontLightHigh1",
            real_lights,
            math.radians(70),
            25,
            0.4,
            (0.85, 0.85, 1),
            rotation=(math.radians(-80), 0, math.radians(8)),
            translate=(-0.5, -3.5, 0.6),
        )
        self.create_light(
            "frontLightHigh2",
            front_light_high1,
    ...
    def create_placeable_elements(self, parent):
        ...
        self.create_skel_node(
            "tipOcclusionUpdateArea1End", tip_occlusion_update_area1_start, True, translate=(1, -1, 0)
        )
    ...
    def create_vehicle_component(self, name, data_name, size=(1.0, 1.0, 1.0), translate=(0, 0, 0)):
        ...
        if giants_enabled:
            ...
            component["i3D_collisionFilterGroup"] = "65540"
            component["i3D_collisionFilterMask"] = "4265606019"
